...
ISO_NAME='xubuntu-20.10-desktop-amd64.iso'
...
if ! [ -e "xubuntu-20.10-desktop-amd64.iso" ]
then
...
VBoxManage storageattach "$VM_NAME" --storagectl "IDE Controller" --port 1 --device 0 --type dvddrive --medium "$(pwd)/$ISO_NAME"
